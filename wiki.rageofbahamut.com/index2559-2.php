...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Death_Dragon">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T09:24:06-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Death_Dragon">
		<rdf:type rdf:resource="&wiki;Category-3ADemons_cards"/>
		<rdfs:label>Death Dragon</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Death_Dragon"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Death_Dragon"/>
		...
		<property:Card_atk4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">6914</property:Card_atk4_7>
		<property:Card_atk6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7128</property:Card_atk6_11>
		<property:Card_atk8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7156</property:Card_atk8_15>
		<property:Card_def rdf:datatype="http://www.w3.org/2001/XMLSchema#double">910</property:Card_def>
		<property:Card_def4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4685</property:Card_def4_7>
		<property:Card_def6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4830</property:Card_def6_11>
		<property:Card_def8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4848</property:Card_def8_15>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Demons</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">DeathDragon1.jpg</property:Card_img>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">DeathDragon4.jpg</property:Card_max_img>
		...
		<property:Card_maxatk rdf:datatype="http://www.w3.org/2001/XMLSchema#double">3350</property:Card_maxatk>
		<property:Card_maxdef rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2270</property:Card_maxdef>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Death Dragon</property:Card_name>
		...
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">As death fell upon the land like a fog, a dragon without a heart rose from the depths. With fangs and nails dulled by the ravages of time, the dragon awoke, oblivious to the fact that it was already dead.</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Strength</property:Card_trait>
		<property:Def_to_pwr rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4.04</property:Def_to_pwr>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-11-07T01:44:05Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457333.5722801</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Death Dragon</swivt:wikiPageSortKey>
	</swivt:Subject>
