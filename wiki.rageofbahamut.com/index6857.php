...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Sunrise_Pascale">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T05:50:55-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Sunrise_Pascale">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Sunrise Pascale</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Sunrise_Pascale"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Sunrise_Pascale"/>
		...
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Solar Call]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Sunrise Pascale1.jpg</property:Card_img>
		...
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Sunrise Pascale4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Celebrate the Sun]</property:Card_max_skill>
		...
		<property:Card_max_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great boost to intelligence cards' damage against raid bosses in [[Dungeon of Delusions]] / Small boost against other raid bosses</property:Card_max_trait_effect>
		<property:Card_max_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Aurora Whirl]</property:Card_max_trait_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Sunrise Pascale</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Celebrate the Sun]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Wow, what a pretty sunrise! It's a morning like any other, but somehow this one feels extra special! Something's gonna happen, I can feel it!</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Intelligence</property:Card_trait>
		<property:Card_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great boost to intelligence cards' damage against raid bosses in [[Dungeon of Delusions]] / Small boost against other raid bosses</property:Card_trait_effect>
		<property:Card_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Aurora Whirl]</property:Card_trait_skill>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-09-21T04:09:48Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457286.6734722</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Sunrise Pascale</swivt:wikiPageSortKey>
	</swivt:Subject>
