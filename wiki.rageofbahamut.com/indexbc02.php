...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Lord_Albert">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T08:46:40-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Lord_Albert">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Lord Albert</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Lord_Albert"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Lord_Albert"/>
		...
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Crackling Fist]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lord Albert1.jpg</property:Card_img>
		...
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lord Albert4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Lightning Burst]</property:Card_max_skill>
		...
		<property:Card_max_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great boost to strength cards' damage against raid bosses in [[Cornered Angels]] / Small boost against other raid bosses</property:Card_max_trait_effect>
		<property:Card_max_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Swift Strike]</property:Card_max_trait_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lord Albert</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Lightning Burst]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">There are times when words solve nothing. If a blade must be drawn to protect the kingdom, let it be mine - for I am the Swiftlevin!</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Strength</property:Card_trait>
		<property:Card_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great boost to strength cards' damage against raid bosses in [[Cornered Angels]] / Small boost against other raid bosses</property:Card_trait_effect>
		<property:Card_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Swift Strike]</property:Card_trait_skill>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-02-07T06:30:19Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457060.7710532</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lord Albert</swivt:wikiPageSortKey>
	</swivt:Subject>
