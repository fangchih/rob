...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Music_Teacher_Douglas">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T03:22:53-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Music_Teacher_Douglas">
		<rdf:type rdf:resource="&wiki;Category-3ADemons_cards"/>
		<rdfs:label>Music Teacher Douglas</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Music_Teacher_Douglas"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Music_Teacher_Douglas"/>
		...
		<property:Card_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great hit to foe's gods/demons DEF  (13 %)</property:Card_effect>
		<property:Card_event_card rdf:datatype="http://www.w3.org/2001/XMLSchema#boolean">true</property:Card_event_card>
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to damage against raid bosses in Mysteria Academy / Medium boost to damage against other raid bosses</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Magical Note]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Demons</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Music Teacher Douglas1.jpeg</property:Card_img>
		<property:Card_max_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great hit to foe's gods/demons DEF  (13 %)</property:Card_max_effect>
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great boost to damage against raid bosses in Mysteria Academy / Medium boost to damage against other raid bosses</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Magical_Solo"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Music Teacher Douglas4.jpeg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Mysterian Rhapsody]</property:Card_max_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Music Teacher Douglas</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Mysterian Rhapsody]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">So you think Magic Music 101 is a worthless class, eh? Hrmph! Well I think casting backwoods spells against each other is far more worthless!</property:Card_story>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-05-27T17:55:22Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456805.2467824</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Music Teacher Douglas</swivt:wikiPageSortKey>
	</swivt:Subject>
