...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Forest_Guardian">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T05:28:07-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Forest_Guardian">
		<rdf:type rdf:resource="&wiki;Category-3AGods_cards"/>
		<rdfs:label>Forest Guardian</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Forest_Guardian"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Forest_Guardian"/>
		...
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Forest Guardian1.jpg</property:Card_img>
		...
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Forest Guardian4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[sacred Lamplight]</property:Card_max_skill>
		...
		<property:Card_max_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Tentative Steps]</property:Card_max_trait_skill>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Forest Guardian</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[sacred Lamplight]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">every night I partol the forest, but the darkness still creeps me out... Still, I have to keep the forest safe, so no more whining!</property:Card_story>
		...
		<property:Card_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Tentative Steps]</property:Card_trait_skill>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-09-22T21:16:45Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457288.3866319</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Forest Guardian</swivt:wikiPageSortKey>
	</swivt:Subject>
