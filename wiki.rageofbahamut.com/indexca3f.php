...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Roy%2C_Valiant_Blade">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T09:11:43-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Roy,_Valiant_Blade">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Roy, Valiant Blade</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Roy,_Valiant_Blade"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Roy,_Valiant_Blade"/>
		...
		<property:Card_atk4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">15666</property:Card_atk4_7>
		<property:Card_atk6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">16152</property:Card_atk6_11>
		<property:Card_atk8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">16212</property:Card_atk8_15>
		...
		<property:Card_def4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">19691</property:Card_def4_7>
		<property:Card_def6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">20302</property:Card_def6_11>
		<property:Card_def8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">20378</property:Card_def8_15>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards based on support deck unit's total PWR required in [[Puppet's Revenge]]</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[One-man Armada]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Roy, Valiant Blade1.jpg</property:Card_img>
		...
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards based on support deck unit's total PWR required in [[Puppet's Revenge]]</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;One-2Dman_Armada"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Roy, Valiant Blade4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Trinity Blade]</property:Card_max_skill>
		...
		<property:Card_maxatk rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7590</property:Card_maxatk>
		<property:Card_maxdef rdf:datatype="http://www.w3.org/2001/XMLSchema#double">9540</property:Card_maxdef>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Roy, Valiant Blade</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Trinity Blade]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">My apologies. Word reached me of people plagued by a might dragon in these lands. I bear the beast no malice, but I will slay it all the same.</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Willpower</property:Card_trait>
		<property:Def_to_pwr rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7.55</property:Def_to_pwr>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-02-17T17:28:59Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457071.2284606</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Roy, Valiant Blade</swivt:wikiPageSortKey>
	</swivt:Subject>
