...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Lonely_Singer">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T06:01:46-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Lonely_Singer">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Lonely Singer</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Lonely_Singer"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Lonely_Singer"/>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Small boost to ranking shards base on support deck unit's total PWR required in Battle of the Divas</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Isolation Tune]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lonely Singer1.jpg</property:Card_img>
		...
		<property:Card_max_event_skill rdf:resource="&wiki;Isolation_Saga"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lonely Singer4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Flower Song</property:Card_max_skill>
		...
		<property:Card_max_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards for willpower cards in the same support deck unit in Battle of the Divas</property:Card_max_trait_effect>
		<property:Card_max_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Best Friends Forever</property:Card_max_trait_skill>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lonely Singer</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Flower Song</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">No one wants to listen to my song… I'm so lonely… it hurts… The only one who'll say nice things to me… is this flower…</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Willpower</property:Card_trait>
		<property:Card_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Small boost to ranking shards for willpower cards in the same support deck unit in Battle of the Divas</property:Card_trait_effect>
		<property:Card_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Good Friends</property:Card_trait_skill>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-07-08T12:56:00Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457212.0388889</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lonely Singer</swivt:wikiPageSortKey>
	</swivt:Subject>
