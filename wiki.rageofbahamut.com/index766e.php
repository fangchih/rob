...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Fairy_Champion">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T08:00:35-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Fairy_Champion">
		<rdf:type rdf:resource="&wiki;Category-3AGods_cards"/>
		<rdfs:label>Fairy Champion</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Fairy_Champion"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Fairy_Champion"/>
		...
		<property:Card_atk4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">19257</property:Card_atk4_7>
		<property:Card_atk6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">19854</property:Card_atk6_11>
		<property:Card_atk8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">19928</property:Card_atk8_15>
		<property:Card_azure_card_pack rdf:datatype="http://www.w3.org/2001/XMLSchema#boolean">false</property:Card_azure_card_pack>
		<property:Card_def rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2340</property:Card_def>
		<property:Card_def4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">12095</property:Card_def4_7>
		<property:Card_def6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">12470</property:Card_def6_11>
		<property:Card_def8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">12516</property:Card_def8_15>
		<property:Card_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to crusher points upon victory</property:Card_effect>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Gods</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Fairy Champion.jpg</property:Card_img>
		...
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Fairy Champion4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Wisp Edge]</property:Card_max_skill>
		<property:Card_max_stars rdf:resource="&wiki;5"/>
		<property:Card_maxatk rdf:datatype="http://www.w3.org/2001/XMLSchema#double">9330</property:Card_maxatk>
		<property:Card_maxdef rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5860</property:Card_maxdef>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Fairy Champion</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Wisp Blade]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">I have pledged to protect the forest from the tendrils of evil. My homeland has been burned and destroyed once... the lives of my friends stolen. Now it is my turn to prevent the same tragedy from repeating itself!</property:Card_story>
		<property:Def_to_pwr rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5.01</property:Def_to_pwr>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-02-01T02:26:15Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456689.6015625</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Fairy Champion</swivt:wikiPageSortKey>
	</swivt:Subject>
