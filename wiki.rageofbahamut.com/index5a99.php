...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Card_Caster_Mari">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T07:54:54-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Card_Caster_Mari">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Card Caster Mari</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Card_Caster_Mari"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Card_Caster_Mari"/>
		...
		<property:Card_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big Boost to Man/Demons ATK/DEF</property:Card_effect>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Card Caster Mari1.jpg</property:Card_img>
		<property:Card_legend_card_pack rdf:datatype="http://www.w3.org/2001/XMLSchema#boolean">false</property:Card_legend_card_pack>
		<property:Card_max_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big Boost to Man/Demons ATK/DEF</property:Card_max_effect>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Card Caster Mari4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Magical Deck</property:Card_max_skill>
		<property:Card_max_stars rdf:resource="&wiki;5"/>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Card Caster Mari</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Magical Deck</property:Card_skill>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-02-02T12:24:05Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457056.0167245</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Card Caster Mari</swivt:wikiPageSortKey>
	</swivt:Subject>
