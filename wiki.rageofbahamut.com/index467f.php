...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Bodyguard_Bolt">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T01:49:15-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Bodyguard_Bolt">
		<rdf:type rdf:resource="&wiki;Category-3ADemons_cards"/>
		<rdfs:label>Bodyguard Bolt</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Bodyguard_Bolt"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Bodyguard_Bolt"/>
		...
		<property:Card_def rdf:datatype="http://www.w3.org/2001/XMLSchema#double">3810</property:Card_def>
		<property:Card_def4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">19670</property:Card_def4_7>
		<property:Card_def6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">20280</property:Card_def6_11>
		<property:Card_def8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">20356</property:Card_def8_15>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards based on support deck unit's PWR required in [[Hanna Comes Home]]</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Demonic Yearning]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Demons</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Bodyguard Bolt1.jpg</property:Card_img>
		...
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards based on support deck unit's PWR required in [[Hanna Comes Home]]</property:Card_max_event_effect>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Bodyguard Bolt4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Revenge Pact]</property:Card_max_skill>
		...
		<property:Card_maxdef rdf:datatype="http://www.w3.org/2001/XMLSchema#double">9530</property:Card_maxdef>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Bodyguard Bolt</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Revenge Pact]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">You need anything? I charge for my services. I work hard for what I'm paid, of course. Hey, take whatever price you just thought of, and multiply it by a thousand.</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Willpower</property:Card_trait>
		<property:Def_to_pwr rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7.54</property:Def_to_pwr>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-06-14T10:09:25Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457187.923206</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Bodyguard Bolt</swivt:wikiPageSortKey>
	</swivt:Subject>
