...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Axe_Fighter">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T01:28:50-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Axe_Fighter">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Axe Fighter</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Axe_Fighter"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Axe_Fighter"/>
		...
		<property:Card_def4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">6997</property:Card_def4_7>
		<property:Card_def6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7214</property:Card_def6_11>
		<property:Card_def8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7242</property:Card_def8_15>
		...
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Axe_Fighter1.jpeg</property:Card_img>
		...
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Axe_Fighter4.jpeg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Crush and Smash</property:Card_max_skill>
		...
		<property:Card_maxdef rdf:datatype="http://www.w3.org/2001/XMLSchema#double">3390</property:Card_maxdef>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Axe Fighter</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Crush and Smash</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">The crushing blade of my axe will be the last thing you feel. There's no way, no how, that you will be able to stand again. If you have time to reinforce your defenses, it's best for you to turn tail and run!</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Strength</property:Card_trait>
		<property:Def_to_pwr rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5.17</property:Def_to_pwr>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-06-19T01:07:34Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456827.5469213</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Axe Fighter</swivt:wikiPageSortKey>
	</swivt:Subject>
