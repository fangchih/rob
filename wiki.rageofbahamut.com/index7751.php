...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Lightning_Shooter">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T08:45:48-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Lightning_Shooter">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Lightning Shooter</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Lightning_Shooter"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Lightning_Shooter"/>
		...
		<property:Card_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to man ATK  (13 %)</property:Card_effect>
		<property:Card_event_card rdf:datatype="http://www.w3.org/2001/XMLSchema#boolean">true</property:Card_event_card>
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to damage against Fiendish Creations in [[Altered Destiny]] / Medium boost to damage against other raid bosses.</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Finger Spark]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lightning Shooter1.jpg</property:Card_img>
		<property:Card_legend_card_pack rdf:datatype="http://www.w3.org/2001/XMLSchema#boolean">false</property:Card_legend_card_pack>
		<property:Card_max_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to man ATK  (13 %)</property:Card_max_effect>
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great boost to damage against Fiendish Creations in [[Altered Destiny]] / Medium boost to damage against other raid bosses.</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Finger_Bolt"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lightning Shooter4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Jupiter's Arrow</property:Card_max_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lightning Shooter</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Jupiter's Arrow</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">My lightning magic is a little different from the rest. Do you see the sparks coming from my fingertip? You'd better stand back...</property:Card_story>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-05-25T06:52:25Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456802.7864005</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Lightning Shooter</swivt:wikiPageSortKey>
	</swivt:Subject>
