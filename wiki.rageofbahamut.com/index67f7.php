...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Summertime_Cerberus">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T02:47:34-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Summertime_Cerberus">
		<rdf:type rdf:resource="&wiki;Category-3ADemons_cards"/>
		<rdfs:label>Summertime Cerberus</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Summertime_Cerberus"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Summertime_Cerberus"/>
		...
		<property:Card_def rdf:datatype="http://www.w3.org/2001/XMLSchema#double">3410</property:Card_def>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Unworldly boost to damage against Jolly's Woes/Big boost to damage against other raid bosses</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Confetti Splash</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Demons</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Summertime Cerberus1.jpg</property:Card_img>
		...
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Unworldly boost to damage against Jolly's Woes/Big boost to damage against other raid bosses</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Confetti_Explosion"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Summertime Cerberus4.jpg</property:Card_max_img>
		...
		<property:Card_max_sells_for rdf:resource="&wiki;185400"/>
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Triple Paradise</property:Card_max_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Summertime Cerberus</property:Card_name>
		...
		<property:Card_sells_for rdf:datatype="http://www.w3.org/2001/XMLSchema#double">61800</property:Card_sells_for>
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Triple Paradise</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">The ocean breeze... The soothing waves... Everything is perfect... woof. Just thinking about having to return to the underworld... what a dog-downer. Oh well. Time to live in the moment and  have a blast.</property:Card_story>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-06-07T23:01:57Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456816.4596875</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Summertime Cerberus</swivt:wikiPageSortKey>
	</swivt:Subject>
