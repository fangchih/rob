...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Themis">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T11:58:46-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Themis">
		<rdf:type rdf:resource="&wiki;Category-3AGods_cards"/>
		<rdfs:label>Themis</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Themis"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Themis"/>
		...
		<property:Card_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great hit to foe's man/demons DEF  (13 %)</property:Card_effect>
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to banishing points and ATK in battles against vampire nobles in the Wing of Dawnbreak and the Scarlet Throne when included in the support deck</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Requital</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Gods</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Themis.jpg</property:Card_img>
		<property:Card_max_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great hit to foe's man/demons DEF  (13 %)</property:Card_max_effect>
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to banishing points and ATK in battles against vampire nobles in the Wing of Dawnbreak and the Scarlet Throne when included in the support deck</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Requital"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Themis4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Scale of Law</property:Card_max_skill>
		<property:Card_max_stars rdf:resource="&wiki;6"/>
		<property:Card_max_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">?</property:Card_max_trait>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Themis</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Scale of Law</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">I am the molder of Justice.  Come to my throne of law, sinner.  My sword of righteousness shall judge you within the boundaries of this divine sanctuary.  Fear not; if you are innocent, my blade is but a harmless toy.</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">?</property:Card_trait>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-06-20T17:48:30Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456829.2420139</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Themis</swivt:wikiPageSortKey>
	</swivt:Subject>
