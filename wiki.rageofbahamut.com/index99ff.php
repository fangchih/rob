...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Trap_Maker">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T05:47:31-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Trap_Maker">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Trap Maker</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Trap_Maker"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Trap_Maker"/>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Small boost to ranking shards based on support deck unit's total PWR required in [[Murder in Black and White]]</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Deft Devices]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Trap Maker1.jpg</property:Card_img>
		...
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards based on support deck unit's total PWR required in [[Murder in Black and White]]</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Devious_Devices"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Trap Maker4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Tripwire]</property:Card_max_skill>
		...
		<property:Card_max_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards for charisma cards in the same support deck unit in [[Murder in Black and White]]</property:Card_max_trait_effect>
		<property:Card_max_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Green Glowing Spike Bomb!]</property:Card_max_trait_skill>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Trap Maker</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Tripwire]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">You're in for a surprise, adventurers. Take one step inside this fortress, and you’ll be up to your neck in traps! Still, exploring could be worth your while, eh?</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Agility</property:Card_trait>
		<property:Card_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Small boost to ranking shards for agility cards in the same support deck unit in [[Murder in Black and White]]</property:Card_trait_effect>
		<property:Card_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Bear Trap]</property:Card_trait_skill>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-12-10T17:10:54Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457367.2159028</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Trap Maker</swivt:wikiPageSortKey>
	</swivt:Subject>
