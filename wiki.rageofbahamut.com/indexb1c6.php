...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Goldenian_Mage_Allen">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T02:55:57-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Goldenian_Mage_Allen">
		<rdf:type rdf:resource="&wiki;Category-3ADemons_cards"/>
		<rdfs:label>Goldenian Mage Allen</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Goldenian_Mage_Allen"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Goldenian_Mage_Allen"/>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Massive boost to ATK against mirthweald bandits. Massive boost to panchrestia drops upon victory over mirthweald bandits / harvesting mystic flora</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[No Time to Worry]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Demons</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Goldenian Mage Allen1.jpg</property:Card_img>
		...
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Massive boost to ATK against mirthweald bandits. Massive boost to panchrestia drops upon victory over mirthweald bandits / harvesting mystic flora</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Faith_Moves_Mountains"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Goldenian Mage Allen4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Guiding Ambition]</property:Card_max_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Goldenian Mage Allen</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Guiding Ambition]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">6</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">I promised myself when I left Goldenia that I'd find a way to turn the statues back. I won't let my people down. I have to save them!</property:Card_story>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-09-09T18:49:53Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456910.2846412</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Goldenian Mage Allen</swivt:wikiPageSortKey>
	</swivt:Subject>
