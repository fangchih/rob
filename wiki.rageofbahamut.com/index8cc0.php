...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Arch_Witch_Daria">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T01:12:58-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Arch_Witch_Daria">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Arch Witch Daria</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Arch_Witch_Daria"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Arch_Witch_Daria"/>
		...
		<property:Card_atk4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">24273</property:Card_atk4_7>
		<property:Card_atk6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">25026</property:Card_atk6_11>
		<property:Card_atk8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">25120</property:Card_atk8_15>
		<property:Card_azure_card_pack rdf:datatype="http://www.w3.org/2001/XMLSchema#boolean">false</property:Card_azure_card_pack>
		<property:Card_def rdf:datatype="http://www.w3.org/2001/XMLSchema#double">5120</property:Card_def>
		<property:Card_def4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">26440</property:Card_def4_7>
		<property:Card_def6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">27260</property:Card_def6_11>
		<property:Card_def8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">27362</property:Card_def8_15>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Unworldly boost to damage to Monster of the Ball in Masque of the Mad Duke / Big boost to damage against other raid bosses</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Staff of Ages]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Arch Witch Daria1.jpg</property:Card_img>
		...
		<property:Card_max_event_skill rdf:resource="&wiki;Staff_of_Eons"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Arch Witch Daria4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Astral Warp]</property:Card_max_skill>
		...
		<property:Card_maxatk rdf:datatype="http://www.w3.org/2001/XMLSchema#double">11760</property:Card_maxatk>
		<property:Card_maxdef rdf:datatype="http://www.w3.org/2001/XMLSchema#double">12810</property:Card_maxdef>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Arch Witch Daria</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Astral Warp]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Daria is famous, known throughout the lands. Capable of magic that exceeds realistic thought, she can go beyond the realm of common sense and perform unworldly deeds.</property:Card_story>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-06-08T00:48:04Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456816.5333796</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Arch Witch Daria</swivt:wikiPageSortKey>
	</swivt:Subject>
