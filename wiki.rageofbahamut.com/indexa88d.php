...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Skeletal_Hero">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T02:46:51-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Skeletal_Hero">
		<rdf:type rdf:resource="&wiki;Category-3ADemons_cards"/>
		<rdfs:label>Skeletal Hero</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Skeletal_Hero"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Skeletal_Hero"/>
		...
		<property:Card_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Unworldly boost to gods/demon ATK</property:Card_effect>
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Unworldly boost to ranking shards based on support deck unit's total PWR required in Scarlet Portraits</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Soul Condemned</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Demons</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Skeletal Hero1.jpg</property:Card_img>
		<property:Card_legend_card_pack rdf:datatype="http://www.w3.org/2001/XMLSchema#boolean">false</property:Card_legend_card_pack>
		<property:Card_max_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Unworldly boost to gods/demon ATK</property:Card_max_effect>
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Unworldly boost to ranking shards based on support deck unit's total PWR required in Scarlet Portraits</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Soul_Condemned"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Skeletal Hero4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Doom Soul]</property:Card_max_skill>
		...
		<property:Card_max_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Worthy Sacrifice</property:Card_max_trait_skill>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Skeletal Hero</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Doom Soul]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">7</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">In the land torn asunder by hell's minions and the king's legions, one heroic commander confronted certain defeat. Yet he vowed to defend his compatriots to the very end.</property:Card_story>
		...
		<property:Card_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Worthy Sacrifice</property:Card_trait_skill>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-02-24T09:28:19Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457077.8946644</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Skeletal Hero</swivt:wikiPageSortKey>
	</swivt:Subject>
