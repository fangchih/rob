...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Elven_Sage">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T09:37:46-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Elven_Sage">
		<rdf:type rdf:resource="&wiki;Category-3AGods_cards"/>
		<rdfs:label>Elven Sage</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Elven_Sage"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Elven_Sage"/>
		...
		<property:Card_def4_7 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">21982</property:Card_def4_7>
		<property:Card_def6_11 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">22664</property:Card_def6_11>
		<property:Card_def8_15 rdf:datatype="http://www.w3.org/2001/XMLSchema#double">22748</property:Card_def8_15>
		...
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Elven_Sage1.jpg</property:Card_img>
		...
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Elven_Sage4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Sylvan Protection]</property:Card_max_skill>
		...
		<property:Card_maxdef rdf:datatype="http://www.w3.org/2001/XMLSchema#double">10650</property:Card_maxdef>
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Elven Sage</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Sylvan Protection]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">6</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">The light that streams through the canopy above is a message from heaven to the learned. We sages are prisms who scatter that light to all who live in these hollowed woodlands.</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">?</property:Card_trait>
		<property:Def_to_pwr rdf:datatype="http://www.w3.org/2001/XMLSchema#double">6.69</property:Def_to_pwr>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-09-10T05:27:07Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456910.7271644</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Elven Sage</swivt:wikiPageSortKey>
	</swivt:Subject>
