...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Ark_Hounds_Kima_%26_Kimi">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T01:19:30-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Ark_Hounds_Kima_-26_Kimi">
		<rdf:type rdf:resource="&wiki;Category-3ADemons_cards"/>
		<rdfs:label>Ark Hounds Kima &amp; Kimi</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Ark_Hounds_Kima_%26_Kimi"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Ark_Hounds_Kima_%26_Kimi"/>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Small boost to ranking shards based on support deck unit's total PWR required in [[Epicurean Lord's Arena]]</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Special Essence]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Demons</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Ark Hounds Kima &amp; Kimi1.jpg</property:Card_img>
		...
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards based on support deck unit's total PWR required in [[Epicurean Lord's Arena]]</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Excellent_Essence"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Ark Hounds Kima &amp; Kimi4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Fabulous Bite]</property:Card_max_skill>
		...
		<property:Card_max_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Big boost to ranking shards for willpower cards in the same support deck unit in [[Epicurean Lord's Arena]]</property:Card_max_trait_effect>
		<property:Card_max_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Double Dog]</property:Card_max_trait_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Ark Hounds Kima &amp; Kimi</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Fabulous Bite]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">“We are the strongest canine siblings that have ever lived!” “I may not be a match for my big brother on my own, but we’ve grown strong together!</property:Card_story>
		<property:Card_trait rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Willpower</property:Card_trait>
		<property:Card_trait_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Small boost to ranking shards for willpower cards in the same support deck unit in [[Epicurean Lord's Arena]]</property:Card_trait_effect>
		<property:Card_trait_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Double Claw]</property:Card_trait_skill>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2015-09-29T19:03:47Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2457295.294294</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Ark Hounds Kima &amp; Kimi</swivt:wikiPageSortKey>
	</swivt:Subject>
