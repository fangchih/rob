...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Anubis">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T01:06:24-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Anubis">
		<rdf:type rdf:resource="&wiki;Category-3ADemons_cards"/>
		<rdfs:label>Anubis</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Anubis"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Anubis"/>
		...
		<property:Card_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Massive boost to demons DEF  (20 %)</property:Card_effect>
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Massive boost to ATK against temple raiders. Massive boost to amenta shards upon victory over temple raiders / entombing of mummies.</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Doom Scale]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Demons</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Anubis1.jpg</property:Card_img>
		<property:Card_max_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Massive boost to demons DEF  (20 %)</property:Card_max_effect>
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Massive boost to ATK against temple raiders. Massive boost to amenta shards upon victory over temple raiders / entombing of mummies.</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Underworld_Scale"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Anubis4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Judgment of Souls]</property:Card_max_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Anubis</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Judgment of Souls]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">6</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Welcome to my domain. Let's see here, the child of a shepherd... lived as a buthcer. You pass. Make yourself at home, denizen.</property:Card_story>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-06-07T23:53:00Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456816.4951389</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Anubis</swivt:wikiPageSortKey>
	</swivt:Subject>
