...
<rdf:RDF
	...
	<owl:Ontology rdf:about="http://wiki.rageofbahamut.com/Special:ExportRDF/Master_Cavalry">
		<swivt:creationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2016-08-16T08:53:03-04:00</swivt:creationDate>
		<owl:imports rdf:resource="http://semantic-mediawiki.org/swivt/1.0"/>
	</owl:Ontology>
	<swivt:Subject rdf:about="http://wiki.rageofbahamut.com/Special:URIResolver/Master_Cavalry">
		<rdf:type rdf:resource="&wiki;Category-3AMan_cards"/>
		<rdfs:label>Master Cavalry</rdfs:label>
		<swivt:page rdf:resource="http://wiki.rageofbahamut.com/Master_Cavalry"/>
		<rdfs:isDefinedBy rdf:resource="http://wiki.rageofbahamut.com/Special:ExportRDF/Master_Cavalry"/>
		...
		<property:Card_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Small boost to damage against raid bosses in [[Ice Throne]] / Small boost to damage against other raid bosses</property:Card_event_effect>
		<property:Card_event_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Lonely cry]</property:Card_event_skill>
		<property:Card_faction rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Man</property:Card_faction>
		<property:Card_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Master Cavalry1.jpg</property:Card_img>
		...
		<property:Card_max_event_effect rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Great boost to damage against raid bosses in [[Ice Throne]] / Small boost to damage against other raid bosses</property:Card_max_event_effect>
		<property:Card_max_event_skill rdf:resource="&wiki;Ride_for_All"/>
		<property:Card_max_evo_forms rdf:resource="&wiki;4"/>
		<property:Card_max_img rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Master Cavalry4.jpg</property:Card_max_img>
		...
		<property:Card_max_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Stampeding Arrow]</property:Card_max_skill>
		...
		<property:Card_name rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Master Cavalry</property:Card_name>
		...
		<property:Card_skill rdf:datatype="http://www.w3.org/2001/XMLSchema#string">[Stampeding Arrow]</property:Card_skill>
		<property:Card_stars rdf:datatype="http://www.w3.org/2001/XMLSchema#double">4</property:Card_stars>
		<property:Card_story rdf:datatype="http://www.w3.org/2001/XMLSchema#string">I am bound by the laws of chivalry. To repay the debts I hold to king and kingdom, I ride into battle with reckless abandon.</property:Card_story>
		...
		<swivt:wikiPageModificationDate rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">2014-06-20T02:53:06Z</swivt:wikiPageModificationDate>
		<property:Modification_date-23aux rdf:datatype="http://www.w3.org/2001/XMLSchema#double">2456828.6202083</property:Modification_date-23aux>
		<swivt:wikiPageSortKey rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Master Cavalry</swivt:wikiPageSortKey>
	</swivt:Subject>
